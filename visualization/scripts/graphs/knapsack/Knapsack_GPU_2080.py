...
ll_data = pd.read_csv('../../../data_aggregation/Knapsack/Knapsack_LL_2080.csv', delimiter=';', header=None)
hl_data = pd.read_csv('../../../data_aggregation/Knapsack/Knapsack_HL_2080.csv', delimiter=';', header=None)
...
for f in range(6):
    for x in range(4):
        ...
        LL_Average[x][f] = ll_data[3][x + (f*4)]
