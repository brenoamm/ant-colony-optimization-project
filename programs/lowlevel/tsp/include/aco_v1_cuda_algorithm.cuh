...
__global__ void route_kernel(int NCITY, int* ROUTES,  double* PHERO, double* c_dist, double* d_probs, curandState* rand_states);

__global__ void route_kernel2(int NCITY, int* routes, double* c_phero, double* c_dist, double* d_probs, int* iroulette, curandState* rand_states);
