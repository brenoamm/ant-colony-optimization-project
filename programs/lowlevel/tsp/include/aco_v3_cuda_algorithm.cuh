...
__global__ void route_kernel(int NCITY, int* routes, double* c_phero, double* c_dist, double* d_probs, curandState* rand_states);
...
__device__ double PHI (int cityi, int cityj, int NCITY, double* c_dist, double* c_phero, double sum);
